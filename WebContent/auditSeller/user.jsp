            ...
            success:function(data){
                 ...
                 for(var i in list){
                     if("0"==list[i].auditStatus){
                         ...
                         "<td align='center'><a href='#'>上架</a>| <a href='#' onclick='del(this)'>删除</a>| <a href='#' id='update' onclick='update("+list[i].id+")'>修改</a></td></tr>";
