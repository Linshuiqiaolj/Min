		...
		$.ajax({
			...
			success : function(da) {
                ...
                $.each(da,function(index,item){
                    ...
                    var Wares_id = item.wares_id;
                    var SpeciID = item.speciID;
                    var NameType = item.nameType;
                    var Name = item.name;
                    var Describe = item.describe;
                    var Money = item.money;
                    var Number = item.number;
                    var UpFrameTime = item.upFrameTime;
                    var Time = item.time;
                    var Downtime = item.downtime;
                    var Audits = item.auditStatus;
                    if("0"==Audits){
                        var html = "<tr><td style='display:none;'>"+Id+"</td><td style='display:none;'>"+Seller_id+"</td><td style='display:none;'>"+Wares_id+"</td><td style='display:none;'>"+SpeciID+"</td><td>"+NameType+"</td><td><a href='#' onclick='query("+Id+")'>"+Name+"</a></td><td>"+Describe+"</td><td>"+Money+"</td><td>"+Number+"</td><td>"+UpFrameTime+"</td><td>"+Time+"</td><td>"+Downtime+"</td><td align='center'><a href='#'>上架</a>| <a href='#' onclick='del(this)'>删除</a>| <a href='#' onclick='update("+Id+")'>修改</a></td></tr>";
                        $("#t_body").append(html);
                    }else if("1"==Audits){
                        var html = "<tr><td style='display:none;'>"+Id+"</td><td style='display:none;'>"+Seller_id+"</td><td style='display:none;'>"+Wares_id+"</td><td style='display:none;'>"+SpeciID+"</td><td>"+NameType+"</td><td><a href='#' onclick='query("+Id+")'>"+Name+"</a></td><td>"+Describe+"</td><td>"+Money+"</td><td>"+Number+"</td><td>"+UpFrameTime+"</td><td>"+Time+"</td><td>"+Downtime+"</td><td align='center'><a href='#' onclick='cancel(this)'>撤销</a></td></tr>";
                        $("#t_body").append(html);
                    }else if("2"==Audits){
                        var html = "<tr><td style='display:none;'>"+Id+"</td><td style='display:none;'>"+Seller_id+"</td><td style='display:none;'>"+Wares_id+"</td><td style='display:none;'>"+SpeciID+"</td><td>"+NameType+"</td><td><a href='#' onclick='query("+Id+")'>"+Name+"</a></td><td>"+Describe+"</td><td>"+Money+"</td><td>"+Number+"</td><td>"+UpFrameTime+"</td><td>"+Time+"</td><td>"+Downtime+"</td><td align='center'><a href='#' onclick='underCarriage(this)'>下架</a></td></tr>";
                        $("#t_body").append(html);
                    }
                });
			}
